...
> > - So when appending 100,000 chars to a String, it certainly take more time than 2X the time to append 50,000 chars.
> >  Because it has to create a new String address for every appending. To sum up, the more you add to a String, the slower you get.
>
